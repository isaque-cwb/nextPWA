...
export default function MyAlert({ title, description, state }: AlertProps) {
    ...
    return (
        <div className="h-screen backdrop-blur-sm  w-full flex fixed top-0 items-center justify-center  ease-in-out ">
            {/* fixed left-[50%] top-[50%] bg-black  translate-x-[-50%] translate-y-[-50%] gap-4 */}

            <div className="bg-teal-100  border-t-4 border-teal-500 rounded-b text-teal-900 px-1 py-3 shadow-md" role="alert">
                <div className="flex ">
